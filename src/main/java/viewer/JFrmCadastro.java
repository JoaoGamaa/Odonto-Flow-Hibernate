...
public class JFrmCadastro extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(JFrmCadastro.class.getName());

    /**
     * Creates new form JFrmCadastro
     */
    public JFrmCadastro() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new JFrmCadastro().setVisible(true));
    }
